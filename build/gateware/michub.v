...
│    │    │    └─── dispatcher (Dispatcher)
│    │    │    │    └─── status_0* (Status)
└─── liteethpacketstream2udptx_0* (LiteEthPacketStream2UDPTX)
│    └─── fifo (SyncFIFO)
│    │    └─── fifo (SyncFIFOBuffered)
│    │    │    └─── fifo (SyncFIFO)
│    └─── fsm (FSM)
...
wire   [39:0] complexslicelowerer_slice_proxy;
...
wire   [31:0] dat_r;
wire   [31:0] dat_w;
reg    [31:0] dummy_data = 32'd305419896;
wire          ecp5pll;
wire          eth_rx_clk;
wire          eth_rx_rst;
wire          eth_tx_clk;
...
reg           liteethpacketstream2udptx_next_state = 1'd0;
reg           liteethpacketstream2udptx_state = 1'd0;
...
reg           michub_bus_error = 1'd0;
reg    [31:0] michub_bus_errors = 32'd0;
reg           michub_bus_errors_re = 1'd0;
wire   [31:0] michub_bus_errors_status;
wire          michub_bus_errors_we;
wire          michub_cpu_rst;
reg           michub_reset_re = 1'd0;
reg     [1:0] michub_reset_storage = 2'd0;
reg           michub_scratch_re = 1'd0;
reg    [31:0] michub_scratch_storage = 32'd305419896;
reg           michub_soc_rst = 1'd0;
...
assign sink_sink_payload_data = dummy_data;
assign sink_sink_valid = 1'd1;
assign sink_sink_first = 1'd1;
assign sink_sink_last = 1'd1;
...
assign michub_bus_errors_status = michub_bus_errors;
        ...
        1'd1: begin
            ...
            if (mac_core_tx_crc_sink_last) begin
                if (mac_core_tx_crc_sink_payload_last_be) begin
                    mac_core_tx_crc_source_payload_data <= complexslicelowerer_slice_proxy[7:0];
                end
...
assign mac_core_tx_padding_sink_valid = mac_core_tx_last_be_source_source_valid;
assign mac_core_tx_last_be_source_source_ready = mac_core_tx_padding_sink_ready;
assign mac_core_tx_padding_sink_first = mac_core_tx_last_be_source_source_first;
assign mac_core_tx_padding_sink_last = mac_core_tx_last_be_source_source_last;
assign mac_core_tx_padding_sink_payload_data = mac_core_tx_last_be_source_source_payload_data;
assign mac_core_tx_padding_sink_payload_last_be = mac_core_tx_last_be_source_source_payload_last_be;
assign mac_core_tx_padding_sink_payload_error = mac_core_tx_last_be_source_source_payload_error;
...
assign mac_core_rx_last_be_sink_valid = mac_core_rx_padding_source_valid;
assign mac_core_rx_padding_source_ready = mac_core_rx_last_be_sink_ready;
assign mac_core_rx_last_be_sink_first = mac_core_rx_padding_source_first;
assign mac_core_rx_last_be_sink_last = mac_core_rx_padding_source_last;
assign mac_core_rx_last_be_sink_payload_data = mac_core_rx_padding_source_payload_data;
assign mac_core_rx_last_be_sink_payload_last_be = mac_core_rx_padding_source_payload_last_be;
assign mac_core_rx_last_be_sink_payload_error = mac_core_rx_padding_source_payload_error;
...
assign mac_core_source_valid = mac_core_rx_cdc_source_source_valid;
assign mac_core_rx_cdc_source_source_ready = mac_core_source_ready;
assign mac_core_source_first = mac_core_rx_cdc_source_source_first;
assign mac_core_source_last = mac_core_rx_cdc_source_source_last;
assign mac_core_source_payload_data = mac_core_rx_cdc_source_source_payload_data;
assign mac_core_source_payload_last_be = mac_core_rx_cdc_source_source_payload_last_be;
assign mac_core_source_payload_error = mac_core_rx_cdc_source_source_payload_error;
always @(*) begin
...
always @(*) begin
    ...
    liteethpacketstream2udptx_next_state <= 1'd0;
    ...
    liteethpacketstream2udptx_next_state <= liteethpacketstream2udptx_state;
    case (liteethpacketstream2udptx_state)
        1'd1: begin
            ...
            source_source_param_length <= 11'd1344;
        ...
        default: begin
            if ((fifo_level1 > 10'd512)) begin
                liteethpacketstream2udptx_next_state <= 1'd1;
            end
        end
    endcase
end
...
always @(*) begin
    michub_soc_rst <= 1'd0;
    if (michub_reset_re) begin
        michub_soc_rst <= michub_reset_storage[0];
    end
end
assign michub_cpu_rst = michub_reset_storage[1];
assign csrbank0_reset0_w = michub_reset_storage[1:0];
assign csrbank0_scratch0_w = michub_scratch_storage[31:0];
assign csrbank0_bus_errors_w = michub_bus_errors_status[31:0];
assign michub_bus_errors_we = csrbank0_bus_errors_we;
...
assign complexslicelowerer_slice_proxy = {mac_core_tx_crc_value, mac_core_tx_crc_sink_payload_data[7:0]};
...
assign mac_core_rx_cdc_cdc_produce_rdomain = multiregimpl51;
assign mac_core_rx_cdc_cdc_consume_wdomain = multiregimpl61;
...
always @(posedge eth_rx_clk) begin
    ...
    multiregimpl60 <= mac_core_rx_cdc_cdc_graycounter1_q;
...
always @(posedge sys_clk) begin
    if ((counter == 26'd49999999)) begin
        counter <= 1'd0;
        dummy_data <= (dummy_data + 1'd1);
    end else begin
        counter <= (counter + 1'd1);
    end
    if ((michub_bus_errors != 32'd4294967295)) begin
        if (michub_bus_error) begin
            michub_bus_errors <= (michub_bus_errors + 1'd1);
        end
    end
    ...
    liteethpacketstream2udptx_state <= liteethpacketstream2udptx_next_state;
    ...
    if (csrbank0_reset0_re) begin
        michub_reset_storage[1:0] <= csrbank0_reset0_r;
    end
    michub_reset_re <= csrbank0_reset0_re;
    if (csrbank0_scratch0_re) begin
        michub_scratch_storage[31:0] <= csrbank0_scratch0_r;
    end
    michub_scratch_re <= csrbank0_scratch0_re;
    michub_bus_errors_re <= csrbank0_bus_errors_re;
    ...
    if (sys_rst) begin
        michub_reset_storage <= 2'd0;
        michub_reset_re <= 1'd0;
        michub_scratch_storage <= 32'd305419896;
        michub_scratch_re <= 1'd0;
        michub_bus_errors_re <= 1'd0;
        michub_bus_errors <= 32'd0;
        ...
        liteethpacketstream2udptx_state <= 1'd0;
    ...
    multiregimpl50 <= mac_core_rx_cdc_cdc_graycounter0_q;
...
always @(posedge eth_rx_clk) begin
	if (mac_core_rx_cdc_cdc_wrport_we)
		storage_2[mac_core_rx_cdc_cdc_wrport_adr] <= mac_core_rx_cdc_cdc_wrport_dat_w;
	storage_2_dat0 <= storage_2[mac_core_rx_cdc_cdc_wrport_adr];
end
always @(posedge sys_clk) begin
	storage_2_dat1 <= storage_2[mac_core_rx_cdc_cdc_rdport_adr];
end
assign mac_core_rx_cdc_cdc_wrport_dat_r = storage_2_dat0;
assign mac_core_rx_cdc_cdc_rdport_dat_r = storage_2_dat1;
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-04-23 01:31:08.
//------------------------------------------------------------------------------
